...
/***/ function(module, exports) {
	...
	var SliderElement = function (_HTMLElement) {
	  _inherits(SliderElement, _HTMLElement);
	
	  function SliderElement() {
	    _classCallCheck(this, SliderElement);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(SliderElement).call(this));
	  }
	  ...
	  _createClass(SliderElement, [{
	    ...
	    value: function next() {
	      ...
	      var end = start - this.widthContent;
	      this.offset = end;
	    ...
	    value: function play() {
	      ...
	      var event = new CustomEvent('started', { bubbles: true, composed: true, detail: this.counter });
	    ...
	    value: function pause() {
	      var event = new CustomEvent('stopped', { bubbles: true, composed: true, detail: this.counter });
	      this.dispatchEvent(event);
	    ...
	    value: function connectedCallback() {
	      ...
	      var _shadowRoot$querySele = this.shadowRoot.querySelector('.content').getBoundingClientRect();
	
	      var width = _shadowRoot$querySele.width;
	      var height = _shadowRoot$querySele.height;
	      ...
	      this.btnRear.addEventListener('click', function () {
	        return _this3.prev();
	      });
